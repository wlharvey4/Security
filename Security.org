...
#+author:Pinecone062
#+date:May 8, 2019
#+macro:version 0.5.1.<2019-05-09 Thu 05:36>
...
:subject:  JWT Angular
:END:
*** About AngularJS Authentication with JWT
...
#+CINDEX:Express
#+CINDEX:Faker
00:21 First of, we're going to need our JavaScript file. We'll call that Server
js. A couple of things that we're going to need through NPNR, Express and
Faker.
