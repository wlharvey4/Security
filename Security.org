...
#+author:Pinecone062
#+date:May 13, 2019
#+macro:version 0.6.4.<2019-05-13 Mon 23:49>
...
**** Create the Angular App in ~app1.js~
#+CINDEX:@file{app1.js}
...
.phony : static-server
static-server :
	cd public && ln -fs $(APP) app.js

.phony : static-server1
static-server1 : APP = app1.js
static-server1 : static-server
	$(START_STATIC_SERVER) &
	$(OPEN_FRONT_END_URI) &
#+end_src
