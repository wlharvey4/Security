...
#+macro:version 0.9.1.<2019-12-09 Mon>
...
authenticate your user, and then grant your user access to another AWS service.
...
2. Next, your app exchanges the user pool tokens for AWS credentials through an
   identity pool.
