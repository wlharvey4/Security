...
#+author:Pinecone062
#+date:May 17, 2019
#+macro:version 0.7.2.<2019-05-17 Fri 13:42>
...
**** Get the Token
01:52 Then here, =getToken= will just simply return =store.getitemkey=, and our
=setToken= will say if a token is provided then we'll say
=store.setitemkeytoken= else =store.removeitem=.  Now we have our
=AuthTokenFactory=.
