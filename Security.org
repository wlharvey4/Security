...
#+author:Pinecone062
#+date:April 14, 2019
#+macro:version 0.2.10.<2019-05-01 Wed 11:48>
...
**** Setting Up Middleware to Check the Secret
...
02:24 Now, if we try a route again, we see that we're getting an error message,
saying that no authorization token was found.

Let's go to the Authorization section, and select a Bearer Token type of
authentication.

02:38 We can take a valid token from ~jwt.io~ in this case, and simply paste
that in the token box in Postman.
